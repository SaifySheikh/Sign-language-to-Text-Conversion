...
from autocorrect import Speller #instead of hunspell
from string import ascii_uppercase

class Application:
    def __init__(self):
        self.directory = 'model'
        self.spell = Speller()  # Initialize autocorrect
    ...
    def load_model(self, json_file, weights_file):
        ...
        weights_file_path = os.path.join(self.directory, weights_file)
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            predicts = self.spell(self.word)  # Using autocorrect instead of hunspell
            if len(predicts) > 0:
